...
{
public:
    BatchCoprocessorHandler(CoprocessorContext & cop_context_, const coprocessor::BatchRequest * cop_request_, coprocessor::BatchResponse * response_);
...
protected:
    ...
    coprocessor::BatchResponse * cop_response;

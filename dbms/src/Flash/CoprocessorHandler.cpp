...
grpc::Status CoprocessorHandler::execute()
{
    ...
    try
    {
        ...
        case COP_REQ_TYPE_DAG:
        {
            ...
            DAGContext dag_context(dag_request, std::move(tables_regions_info), cop_context.db_context.getClientInfo().current_address.toString(), /*is_batch_cop*/ false, Logger::get("CoprocessorHandler"));

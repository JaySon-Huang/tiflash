...
{
    return " max_bytes_per_sec: " + std::to_string(max_bytes_per_sec) + " mode: " + std::to_string(static_cast<UInt32>(mode))
        + " fg_write_weight: " + std::to_string(fg_write_weight) + " bg_write_weight: " + std::to_string(bg_write_weight);
}
...
{
    return config.max_bytes_per_sec == max_bytes_per_sec && config.mode == mode && config.bg_write_weight == bg_write_weight

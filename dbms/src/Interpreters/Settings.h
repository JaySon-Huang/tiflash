...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, dt_filecache_wait_on_downloading_segment_ms, 50, "Max waiting time in milliseconds for reusing an on-going download of the same key in FileCache::get.")                                                                                  \
    M(SettingUInt64, dt_filecache_retry_on_too_many_downloading_ms, 10, "Backoff time in milliseconds before retrying FileCache::get once after too-many-downloading rejection.")                                                                                \
    ...
    M(SettingUInt64, disagg_build_read_task_batch_size, 16, "Batch size of SegmentReadTask build units in disaggregated read task construction. 0 is treated as 1.")                                                                    \

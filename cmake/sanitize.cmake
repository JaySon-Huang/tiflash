...
if (SANITIZE)
    ...
    elseif (SANITIZE STREQUAL "thread")
        ...
        if (COMPILER_CLANG)
            ...
            message (WARNING
                "TSAN suppressions was not passed to the compiler (since the compiler is not clang)\n"
                "Use the following command to pass them manually:\n"
                "    export TSAN_OPTIONS=\"$TSAN_OPTIONS suppressions=${CMAKE_SOURCE_DIR}/tests/tsan_suppressions.txt\""
            )
        endif()
    ...
    elseif (SANITIZE STREQUAL "undefined")
        ...
        if (COMPILER_CLANG)
            ...
            message (WARNING
                "UBSAN suppressions was not passed to the compiler (since the compiler is not clang)\n"
                "Use the following command to pass them manually:\n"
                "    export UBSAN_OPTIONS=\"$UBSAN_OPTIONS suppressions=${CMAKE_SOURCE_DIR}/tests/ubsan_suppressions.txt\""
            )
        endif()
